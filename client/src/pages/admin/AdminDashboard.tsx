...
const PLATFORM_CLASSES: PlatformClass[] = [
  ...
  { id: 2, name: 'StarCamp Batch 2', trainers: ['Tran Thi Mai'], trainerInitials: 'TM', students: 18, problems: 28, status: 'active', progress: 45, endDate: 'Apr 15, 2025' },
  { id: 3, name: 'WeCamp Batch 14', trainers: ['Le Van An'], trainerInitials: 'LA', students: 22, problems: 30, status: 'active', progress: 88, endDate: 'Nov 30, 2024' },
  { id: 4, name: 'StarCamp Batch 1', trainers: ['Pham Thi Huong'], trainerInitials: 'PH', students: 20, problems: 25, status: 'inactive', progress: 100, endDate: 'Dec 20, 2024' },
]
...
const ADMIN_SUBS: AdminSub[] = [
  ...
  { id: 2, student: 'Bob Tran', problem: 'Process Scheduling', subject: 'OS', class: 'WeCamp Batch 15', trainer: 'Nguyen Van Hung', status: 'pending', waitingDays: 4, isLate: false },
  { id: 3, student: 'Carol Lee', problem: 'Binary Search', subject: 'DSA', class: 'WeCamp Batch 15', trainer: 'Nguyen Van Hung', status: 'pending', waitingDays: 3, isLate: true },
  { id: 4, student: 'Ha Pham', problem: 'SQL Query', subject: 'Database', class: 'WeCamp Batch 15', trainer: 'Nguyen Van Hung', status: 'pending', waitingDays: 3, isLate: false },
  { id: 5, student: 'Minh Le', problem: 'DFS', subject: 'DSA', class: 'WeCamp Batch 15', trainer: 'Nguyen Van Hung', status: 'pending', waitingDays: 2, isLate: false },
  { id: 6, student: 'Lan Nguyen', problem: 'Graph BFS', subject: 'DSA', class: 'WeCamp Batch 15', trainer: 'Nguyen Van Hung', status: 'pending', waitingDays: 2, isLate: false },
  { id: 7, student: 'Nam Tran', problem: 'Linked List', subject: 'DSA', class: 'WeCamp Batch 15', trainer: 'Nguyen Van Hung', status: 'pending', waitingDays: 1, isLate: false },
  { id: 8, student: 'Hoa Le', problem: 'Memory Mgmt', subject: 'OS', class: 'WeCamp Batch 15', trainer: 'Nguyen Van Hung', status: 'pending', waitingDays: 1, isLate: false },
  { id: 9, student: 'Tuan Pham', problem: 'SQL Join', subject: 'Database', class: 'WeCamp Batch 15', trainer: 'Nguyen Van Hung', status: 'pending', waitingDays: 1, isLate: false },
  { id: 10, student: 'Mai Nguyen', problem: 'Merge Sort', subject: 'DSA', class: 'WeCamp Batch 15', trainer: 'Nguyen Van Hung', status: 'pending', waitingDays: 0, isLate: false },
  { id: 11, student: 'Long Tran', problem: 'Deadlock', subject: 'OS', class: 'WeCamp Batch 15', trainer: 'Nguyen Van Hung', status: 'pending', waitingDays: 0, isLate: false },
  { id: 12, student: 'Bao Le', problem: 'SQL Agg', subject: 'Database', class: 'WeCamp Batch 15', trainer: 'Nguyen Van Hung', status: 'pending', waitingDays: 0, isLate: false },
  { id: 13, student: 'Kim Nguyen', problem: 'Two Sum', subject: 'DSA', class: 'WeCamp Batch 15', trainer: 'Nguyen Van Hung', status: 'reviewed', waitingDays: 0, isLate: false },
  { id: 14, student: 'Duc Tran', problem: 'DFS', subject: 'DSA', class: 'WeCamp Batch 15', trainer: 'Nguyen Van Hung', status: 'reviewed', waitingDays: 0, isLate: false },
  { id: 15, student: 'An Pham', problem: 'SQL Query', subject: 'Database', class: 'WeCamp Batch 15', trainer: 'Nguyen Van Hung', status: 'reviewed', waitingDays: 0, isLate: false },
  { id: 16, student: 'Thu Le', problem: 'Thread Sync', subject: 'OS', class: 'WeCamp Batch 15', trainer: 'Nguyen Van Hung', status: 'reviewed', waitingDays: 0, isLate: false },
  { id: 17, student: 'Viet Nguyen', problem: 'Graph BFS', subject: 'DSA', class: 'StarCamp Batch 2', trainer: 'Tran Thi Mai', status: 'pending', waitingDays: 5, isLate: true },
  { id: 18, student: 'Hieu Tran', problem: 'Memory Mgmt', subject: 'OS', class: 'StarCamp Batch 2', trainer: 'Tran Thi Mai', status: 'pending', waitingDays: 3, isLate: false },
  { id: 19, student: 'Thao Le', problem: 'SQL Join', subject: 'Database', class: 'StarCamp Batch 2', trainer: 'Tran Thi Mai', status: 'pending', waitingDays: 2, isLate: false },
  { id: 20, student: 'Phuong Pham', problem: 'Binary Search', subject: 'DSA', class: 'StarCamp Batch 2', trainer: 'Tran Thi Mai', status: 'pending', waitingDays: 2, isLate: false },
  { id: 21, student: 'Khanh Nguyen', problem: 'Deadlock', subject: 'OS', class: 'StarCamp Batch 2', trainer: 'Tran Thi Mai', status: 'pending', waitingDays: 1, isLate: false },
  { id: 22, student: 'Linh Tran', problem: 'Merge Sort', subject: 'DSA', class: 'StarCamp Batch 2', trainer: 'Tran Thi Mai', status: 'pending', waitingDays: 1, isLate: false },
  { id: 23, student: 'Tuyen Le', problem: 'SQL Agg', subject: 'Database', class: 'StarCamp Batch 2', trainer: 'Tran Thi Mai', status: 'pending', waitingDays: 0, isLate: false },
  { id: 24, student: 'Quan Pham', problem: 'DFS', subject: 'DSA', class: 'StarCamp Batch 2', trainer: 'Tran Thi Mai', status: 'pending', waitingDays: 0, isLate: false },
  { id: 25, student: 'Trang Nguyen', problem: 'Two Sum', subject: 'DSA', class: 'StarCamp Batch 2', trainer: 'Tran Thi Mai', status: 'reviewed', waitingDays: 0, isLate: false },
  { id: 26, student: 'Duy Tran', problem: 'SQL Query', subject: 'Database', class: 'StarCamp Batch 2', trainer: 'Tran Thi Mai', status: 'reviewed', waitingDays: 0, isLate: false },
  { id: 27, student: 'Nhi Le', problem: 'Thread Sync', subject: 'OS', class: 'StarCamp Batch 2', trainer: 'Tran Thi Mai', status: 'reviewed', waitingDays: 0, isLate: false },
  { id: 28, student: 'Son Nguyen', problem: 'Linked List', subject: 'DSA', class: 'WeCamp Batch 14', trainer: 'Le Van An', status: 'pending', waitingDays: 2, isLate: false },
  { id: 29, student: 'Hong Tran', problem: 'Process Scheduling', subject: 'OS', class: 'WeCamp Batch 14', trainer: 'Le Van An', status: 'pending', waitingDays: 1, isLate: false },
  { id: 30, student: 'Nhung Le', problem: 'SQL Index', subject: 'Database', class: 'WeCamp Batch 14', trainer: 'Le Van An', status: 'pending', waitingDays: 0, isLate: false },
  { id: 31, student: 'Dat Pham', problem: 'Merge Sort', subject: 'DSA', class: 'WeCamp Batch 14', trainer: 'Le Van An', status: 'reviewed', waitingDays: 0, isLate: false },
  { id: 32, student: 'Nga Nguyen', problem: 'DFS', subject: 'DSA', class: 'WeCamp Batch 14', trainer: 'Le Van An', status: 'reviewed', waitingDays: 0, isLate: false },
  { id: 33, student: 'Tai Tran', problem: 'SQL Agg', subject: 'Database', class: 'WeCamp Batch 14', trainer: 'Le Van An', status: 'reviewed', waitingDays: 0, isLate: false },
  { id: 34, student: 'Bich Le', problem: 'Memory Mgmt', subject: 'OS', class: 'WeCamp Batch 14', trainer: 'Le Van An', status: 'reviewed', waitingDays: 0, isLate: false },
  { id: 35, student: 'Bien Pham', problem: 'Binary Search', subject: 'DSA', class: 'WeCamp Batch 14', trainer: 'Le Van An', status: 'reviewed', waitingDays: 0, isLate: false },
  { id: 36, student: 'Cuc Nguyen', problem: 'Deadlock', subject: 'OS', class: 'WeCamp Batch 14', trainer: 'Le Van An', status: 'reviewed', waitingDays: 0, isLate: false },
  { id: 37, student: 'Dan Tran', problem: 'SQL Join', subject: 'Database', class: 'WeCamp Batch 14', trainer: 'Le Van An', status: 'reviewed', waitingDays: 0, isLate: false },
  { id: 38, student: 'Em Nguyen', problem: 'Two Sum', subject: 'DSA', class: 'StarCamp Batch 1', trainer: 'Pham Thi Huong', status: 'reviewed', waitingDays: 0, isLate: false },
  { id: 39, student: 'Gia Tran', problem: 'Binary Search', subject: 'DSA', class: 'StarCamp Batch 1', trainer: 'Pham Thi Huong', status: 'reviewed', waitingDays: 0, isLate: false },
  { id: 40, student: 'Ha Le', problem: 'Thread Sync', subject: 'OS', class: 'StarCamp Batch 1', trainer: 'Pham Thi Huong', status: 'reviewed', waitingDays: 0, isLate: false },
]
...
const STUDENTS: Student[] = [
  {
    ...
    classes: [{
      ...
      submissions: [
        ...
        { problem: 'Merge Sort', subject: 'DSA', submittedAt: 'Sep 12, 09:10', status: 'reviewed' },
        { problem: 'Process Scheduling', subject: 'OS', submittedAt: 'Sep 11, 14:00', status: 'reviewed' },
        { problem: 'SQL Query', subject: 'Database', submittedAt: 'Sep 10, 11:30', status: 'reviewed' },
      ],
    }],
  },
  {
    name: 'Kim Nguyen', initials: 'KN', email: 'kim.nguyen@wecamp.edu',
    classes: [{
      name: 'WeCamp Batch 15', trainer: 'Nguyen Van Hung', trainerInitials: 'NH',
      ...
      submissions: [
        ...
        { problem: 'Graph BFS', subject: 'DSA', submittedAt: 'Sep 13, 10:45', status: 'reviewed' },
        { problem: 'Thread Sync', subject: 'OS', submittedAt: 'Sep 12, 16:00', status: 'reviewed' },
        { problem: 'SQL Join', subject: 'Database', submittedAt: 'Sep 11, 09:00', status: 'reviewed' },
      ],
    }],
  },
  {
    name: 'Duc Tran', initials: 'DT', email: 'duc.tran@wecamp.edu',
    classes: [{
      name: 'WeCamp Batch 15', trainer: 'Nguyen Van Hung', trainerInitials: 'NH',
      ...
      submissions: [
        ...
        { problem: 'Linked List', subject: 'DSA', submittedAt: 'Sep 12, 14:30', status: 'reviewed' },
        { problem: 'Memory Mgmt', subject: 'OS', submittedAt: 'Sep 11, 10:00', status: 'reviewed' },
        { problem: 'SQL Agg', subject: 'Database', submittedAt: 'Sep 10, 15:00', status: 'reviewed' },
      ],
    }],
  },
  {
    name: 'Long Tran', initials: 'LT', email: 'long.tran@wecamp.edu',
    classes: [{
      name: 'WeCamp Batch 15', trainer: 'Nguyen Van Hung', trainerInitials: 'NH',
      ...
      submissions: [
        ...
        { problem: 'SQL Query', subject: 'Database', submittedAt: 'Sep 10, 10:00', status: 'reviewed' },
      ],
    }],
  },
  {
    name: 'Viet Nguyen', initials: 'VN', email: 'viet.nguyen@starcamp.edu',
    classes: [{
      ...
      submissions: [
        ...
        { problem: 'Thread Sync', subject: 'OS', submittedAt: 'Sep 12, 11:00', status: 'reviewed' },
        { problem: 'SQL Agg', subject: 'Database', submittedAt: 'Sep 11, 16:30', status: 'reviewed' },
      ],
    }],
  },
  {
    name: 'Trang Nguyen', initials: 'TN', email: 'trang.nguyen@starcamp.edu',
    classes: [{
      name: 'StarCamp Batch 2', trainer: 'Tran Thi Mai', trainerInitials: 'TM',
      ...
      submissions: [
        ...
        { problem: 'Merge Sort', subject: 'DSA', submittedAt: 'Sep 13, 10:00', status: 'reviewed' },
        { problem: 'Deadlock', subject: 'OS', submittedAt: 'Sep 12, 15:00', status: 'reviewed' },
        { problem: 'SQL Join', subject: 'Database', submittedAt: 'Sep 11, 09:30', status: 'reviewed' },
      ],
    }],
  },
  {
    name: 'Hieu Tran', initials: 'HT', email: 'hieu.tran@starcamp.edu',
    classes: [{
      name: 'StarCamp Batch 2', trainer: 'Tran Thi Mai', trainerInitials: 'TM',
      ...
      submissions: [
        ...
        { problem: 'SQL Query', subject: 'Database', submittedAt: 'Sep 10, 09:00', status: 'reviewed' },
      ],
    }],
  },
  {
    name: 'Son Nguyen', initials: 'SN', email: 'son.nguyen@wecamp.edu',
    classes: [{
      ...
      submissions: [
        ...
        { problem: 'Merge Sort', subject: 'DSA', submittedAt: 'Sep 12, 15:30', status: 'reviewed' },
        { problem: 'Process Scheduling', subject: 'OS', submittedAt: 'Sep 11, 11:00', status: 'reviewed' },
        { problem: 'SQL Index', subject: 'Database', submittedAt: 'Sep 10, 14:00', status: 'reviewed' },
      ],
    }],
  },
  {
    name: 'Dat Pham', initials: 'DP', email: 'dat.pham@wecamp.edu',
    classes: [{
      name: 'WeCamp Batch 14', trainer: 'Le Van An', trainerInitials: 'LA',
      ...
      submissions: [
        ...
        { problem: 'Binary Search', subject: 'DSA', submittedAt: 'Sep 13, 13:00', status: 'reviewed' },
        { problem: 'Deadlock', subject: 'OS', submittedAt: 'Sep 12, 10:00', status: 'reviewed' },
        { problem: 'SQL Agg', subject: 'Database', submittedAt: 'Sep 11, 15:00', status: 'reviewed' },
      ],
    }],
  },
  {
    name: 'Nga Nguyen', initials: 'NN', email: 'nga.nguyen@wecamp.edu',
    classes: [{
      name: 'WeCamp Batch 14', trainer: 'Le Van An', trainerInitials: 'LA',
      ...
      submissions: [
        ...
        { problem: 'Thread Sync', subject: 'OS', submittedAt: 'Sep 12, 12:00', status: 'reviewed' },
        { problem: 'SQL Join', subject: 'Database', submittedAt: 'Sep 11, 10:30', status: 'reviewed' },
      ],
    }],
  },
  {
    name: 'Em Nguyen', initials: 'EN', email: 'em.nguyen@starcamp.edu',
    classes: [{
      ...
      submissions: [
        ...
        { problem: 'Graph BFS', subject: 'DSA', submittedAt: 'Dec 14, 14:00', status: 'reviewed' },
        { problem: 'Memory Mgmt', subject: 'OS', submittedAt: 'Dec 13, 11:00', status: 'reviewed' },
        { problem: 'SQL Query', subject: 'Database', submittedAt: 'Dec 12, 09:00', status: 'reviewed' },
      ],
    }],
  },
  {
    name: 'Gia Tran', initials: 'GT', email: 'gia.tran@starcamp.edu',
    classes: [{
      name: 'StarCamp Batch 1', trainer: 'Pham Thi Huong', trainerInitials: 'PH',
      ...
      submissions: [
        ...
        { problem: 'SQL Agg', subject: 'Database', submittedAt: 'Dec 13, 10:00', status: 'reviewed' },
      ],
    }],
  },
]
