...
const STORAGE_STUDENTS_KEY = 'algozoo_admin_class_students_v3'
...
const DEFAULT_STUDENTS: Record<string, ClassStudent[]> = {
  'wecamp-21': [
    { id: 'cs-1', name: 'Alice Nguyen', username: '@alice123', email: 'alice@gmail.com', joinedDate: 'Sep 1', completedCount: 6, totalProblems: 8 },
    { id: 'cs-2', name: 'Bob Tran', username: '@bob_t', email: 'bob@gmail.com', joinedDate: 'Sep 1', completedCount: 4, totalProblems: 8 },
    { id: 'cs-3', name: 'Carol Lee', username: '@carol_lee', email: 'carol@gmail.com', joinedDate: 'Sep 2', completedCount: 7, totalProblems: 8 },
    { id: 'cs-4', name: 'Minh Pham', username: '@minh_p', email: 'minh@gmail.com', joinedDate: 'Sep 2', completedCount: 3, totalProblems: 8 },
    { id: 'cs-5', name: 'Ha Le', username: '@ha_le', email: 'hale@gmail.com', joinedDate: 'Sep 3', completedCount: 5, totalProblems: 8 },
    { id: 'cs-6', name: 'An Tran', username: '@an_tran', email: 'an@gmail.com', joinedDate: 'Sep 4', completedCount: 2, totalProblems: 8 },
  ],
  'wecamp-15': [
...
export function getClassStudents(classId: string): ClassStudent[] {
  ...
  try {
    ...
    if (raw) {
      const map: Record<string, ClassStudent[]> = JSON.parse(raw)
      const stored = map[classId]
      const defaults = DEFAULT_STUDENTS[classId]
      // If stored data is stale (fewer students than defaults), use defaults
      if (stored && defaults && stored.length < defaults.length) {
        return defaults
      }
      return stored || defaults || DEFAULT_STUDENTS['wecamp-21'] || []
    }
